...
const KELENGKAPAN_DOKUMEN_LIST = [
  { id: 1, label: "Outline Drawing", type: "radio", value: "outline" },
...
export default function FormCreatePemeriksaanPage({
  ...
  const parseKelengkapanFromMarkdown = (markdown: string) => {
    ...
    lines.forEach((line) => {
      ...
      if (trimmed.includes("Outline Drawing") && !trimmed.includes("1.")) {
        gambarValue = "outline";
        checkedItems.add(2);
  ...
  const renderKelengkapanSection = () => (
    <div className="border border-gray-200 rounded-xl p-4 sm:p-6 w-full max-w-full">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div className="flex gap-8">
          <label className="flex items-center cursor-pointer">
            ...
            />
            <span className="ml-2 text-sm text-gray-700">Outline Drawing</span>
          </label>
          <label className="flex items-center cursor-pointer">
            <input
              type="radio"
