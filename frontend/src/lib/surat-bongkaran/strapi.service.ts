...
export class StrapiAPIService {
   ...
   */
  static async createBeritaAcara(data: any): Promise<StrapiResponse> {
    const response = await fetch(
   ...
   * Update Surat Jalan
   */
  static async updateBeritaAcara(
    documentId: string,
    data: any
   ...
   */
  static async getBeritaAcara(id: number): Promise<StrapiResponse> {
    const response = await fetch(
   ...
   * Delete Surat Jalan
   */
  static async deleteBeritaAcara(id: number): Promise<void> {
    const response = await fetch(
  ...
  /**
   * Get emails by berita bongkaran documentId
   */
  static async getEmailsByBeritaBongkaran(
    beritaBongkaranDocumentId: string
  ): Promise<StrapiResponse> {
    const query = qs.stringify({
      filters: {
        surat_jalan: {
          documentId: {
            $eq: beritaBongkaranDocumentId,
          },
        },
      },
      populate: {
