...
export class StrapiAPIService {
  ...
  /**
   * Create Berita Pemeriksaan baru
   */
  static async createBeritaPemeriksaan(data: any): Promise<StrapiResponse> {
    const response = await fetch(
      `${API_CONFIG.baseURL}${API_CONFIG.endpoints.beritaPemeriksaan}`,
      {
        method: "POST",
   ...
   */
  static async updateBeritaPemeriksaan(
    documentId: string,
    data: any
  ): Promise<StrapiResponse> {
    const response = await fetch(
      `${API_CONFIG.baseURL}${API_CONFIG.endpoints.beritaPemeriksaan}/${documentId}`,
      {
        method: "PUT",
        headers: this.getHeaders(),
        body: JSON.stringify({ data }),
  ...
  /**
   * Get Berita Pemeriksaan by ID
   */
  static async getBeritaPemeriksaan(id: number): Promise<StrapiResponse> {
    const response = await fetch(
      `${API_CONFIG.baseURL}${API_CONFIG.endpoints.beritaPemeriksaan}/${id}?populate=*`,
      {
        headers: this.getHeaders(),
      }
    );
  ...
  /**
   * Delete Berita Pemeriksaan
   */
  static async deleteBeritaPemeriksaan(id: number): Promise<void> {
    const response = await fetch(
      `${API_CONFIG.baseURL}${API_CONFIG.endpoints.beritaPemeriksaan}/${id}`,
      {
        method: "DELETE",
        headers: this.getHeaders(),
      }
  ...
  /**
   * Get emails by berita pemeriksaan documentId
   */
  static async getEmailsByBeritaPemeriksaan(
    beritaPemeriksaanDocumentId: string
  ): Promise<StrapiResponse> {
    const query = qs.stringify({
      filters: {
        surat_jalan: {
          documentId: {
            $eq: beritaPemeriksaanDocumentId,
          },
        },
      },
      populate: {
