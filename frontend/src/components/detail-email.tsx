      ...
      <>
        ...
        <div className="flex items-center justify-between mb-4 md:mb-6">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div
              className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-white text-xs sm:text-sm font-medium ${email.avatarBg}`}
            >
              {email.avatar}
            </div>
            <div>
    ...
    <div className="inter mb-6 md:mb-8 space-y-3 md:space-y-4">
      <div className="flex items-center justify-between">
        <span className="text-xs sm:text-sm font-semibold text-[#191919]">
          Surat Jalan NO : 001.SJ/GD.UPT-BDG/IX/2025
        </span>
      ...
      <div className="w-full transform origin-top-left">
        ...
        <div className="bg-white shadow-lg py-4">
          ...
          <div className="grid grid-cols-1 gap-8 mb-6 text-sm">
            <div>
              ...
              <div className="space-y-1 text-lg">
                ...
                <div>
                  Lokasi Asal :{" "}
                  <span className="font-semibold">GUDANG GARENTING</span>
                </div>
                <div>
                  Lokasi Tujuan :{" "}
                  <span className="font-semibold">GI BANDUNG UTARA</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <table className="border-t border-b border-gray-300 text-sm">
              <thead className="bg-gray-100">
                <tr className="text-lg text-center">
                  ...
                  <th className="border-2 border-gray-800 px-2 py-2">JUMLAH</th>
                  <th className="border-2 border-gray-800 px-2 py-2">
          ...
          <div className="pl-3 grid grid-cols-2 gap-8 mb-8 text-lg py-3">
            <div>
              <div>
                <span className="font-semibold">Kendaraan</span> : COLT DIESEL /
                D 8584 HL
              </div>
              <div>
                <span className="font-semibold">Pengemudi</span> : AYI"
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-16 text-sm text-center">
            <div>
              ...
              <div className="font-bold mb-4 text-lg">PT PANDAN WANGI SAE"</div>
              ...
              <div className="text-lg font-bold">PAK JIMBO"</div>
            </div>

            <div>
              <div className="mb-2 text-lg">Yang menyerahkan,</div>
              <div className="font-bold mb-4 text-lg">LOGISTIK UPT BANDUNG</div>
              ...
              <div className="font-bold text-lg">ANDRI SETIAWAN</div>
            </div>
          </div>
        </div>
      </div>
