...
export interface ApiEmailStatusEmailStatus extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'email-statuses';
    singularName: 'email-status';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    bookmarked_at: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEmailEmail extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attachment_files: Schema.Attribute.Media<
    ...
    >;
    subject: Schema.Attribute.String;
    surat_jalan: Schema.Attribute.Relation<
      'manyToOne',
      'api::surat-jalan.surat-jalan'
    >;
    to_company: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
